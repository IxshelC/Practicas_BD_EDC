...
SELECT F.nombre, MAX(P.precio) AS PrecioMáximo, Min(P.precio) AS PrecioMínimo, AVG(P.precio) AS PrecioMedio, COUNT(P.codigo) AS PRODUCTOSTOTALES_PRECIO_MAYOR_200
...
SELECT * FROM producto
WHERE precio > 200 AND codigo_fabricante = "2";
